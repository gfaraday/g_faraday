...
internal object InternalChannels {
    //网络
    private val netChannel by lazy { MethodChannel(Faraday.engine.dartExecutor, "g_faraday_helper/net") }

    //通用
    private val commonChannel by lazy { MethodChannel(Faraday.engine.dartExecutor, "g_faraday_helper/common") }
