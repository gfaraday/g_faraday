 ...
 *
 * <p>A {@code XFlutterView}'s UI is painted by a corresponding {@link FlutterEngine}.
 *
 * <p>A {@code XFlutterView} can operate in 2 different {@link
 ...
 *       XFlutterView} in this mode cannot be positioned between 2 other Android {@code View}s in the
 ...
 *       io.flutter.embedding.android.RenderMode#surface}, but a {@code XFlutterView} in this mode
...
public class XFlutterView extends FrameLayout implements MouseCursorPlugin.MouseCursorViewDelegate {
    ...
    /**
     * Constructs a {@code XFlutterView} programmatically, without any XML attributes.
     *
     * <p>
     *
     * <ul>
     ...
     * </ul>
     *
     * {@code XFlutterView} requires an {@code Activity} instead of a generic {@code Context} to be
    ...
    /**
     * Deprecated - use {@link #XFlutterView(Context, FlutterSurfaceView)} or {@link
     * #XFlutterView(Context, FlutterTextureView)} or {@link #XFlutterView(Context, FlutterImageView)}
     * instead.
     */
    @Deprecated
    ...
    /**
     * Deprecated - use {@link #XFlutterView(Context, FlutterSurfaceView)} or {@link
     * #XFlutterView(Context, FlutterTextureView)} instead, and configure the incoming {@code
     * FlutterSurfaceView} or {@code FlutterTextureView} for transparency as desired.
     *
     * <p>Constructs a {@code XFlutterView} programmatically, without any XML attributes, uses a {@link
     * FlutterSurfaceView} to render the Flutter UI, and allows selection of a {@code
     * transparencyMode}.
     *
     * <p>{@code XFlutterView} requires an {@code Activity} instead of a generic {@code Context} to be
     * compatible with {@link PlatformViewsController}.
     */
    @Deprecated
    ...
    /**
     * Constructs a {@code XFlutterView} programmatically, without any XML attributes, uses the given
    ...
    /**
     * Constructs a {@code XFlutterView} in an XML-inflation-compliant manner.
     *
     * <p>{@code XFlutterView} requires an {@code Activity} instead of a generic {@code Context} to be
     * compatible with {@link PlatformViewsController}.
     */
    ...
    private void init() {
        Log.v(TAG, "Initializing XFlutterView");
        ...
        // XFlutterView needs to be focusable so that the InputMethodManager can interact with it.
        setFocusable(true);
     ...
     *
     * <ol>
     *   <li>{@code flutterEngineA} is attached to this {@code XFlutterView}: returns false
     *   <li>{@code flutterEngineA} renders its first frame to this {@code XFlutterView}: returns true
     *   <li>{@code flutterEngineA} is detached from this {@code XFlutterView}: returns false
     *   <li>{@code flutterEngineB} is attached to this {@code XFlutterView}: returns false
     *   <li>{@code flutterEngineB} renders its first frame to this {@code XFlutterView}: returns true
     * </ol>
     */
    ...
    /**
     * Adds the given {@code listener} to this {@code XFlutterView}, to be notified upon Flutter's
    ...
    /**
     * Invoked when this {@code XFlutterView} changes size, including upon initial measure.
     *
    ...
    protected void onSizeChanged(int width, int height, int oldWidth, int oldHeight) {
        ...
        Log.v(
                TAG,
                "Size changed. Sending Flutter new viewport metrics. XFlutterView was "
                        + oldWidth
                        + " x "
                        + oldHeight
                        + ", it is now "
...
//        }
     ...
     * text-input widgets, therefore {@code XFlutterView} must support an {@code InputConnection}.
     *
     * <p>The {@code InputConnection} returned from this method comes from a {@link TextInputPlugin},
     * which is owned by this {@code XFlutterView}. A {@link TextInputPlugin} exists to encapsulate the
    ...
    /**
     * Connects this {@code XFlutterView} to the given {@link FlutterEngine}.
     *
     * <p>This {@code XFlutterView} will begin rendering the UI painted by the given {@link
     * FlutterEngine}. This {@code XFlutterView} will also begin forwarding interaction events from
     * this {@code XFlutterView} to the given {@link FlutterEngine}, e.g., user touch events,
    ...
    public void attachToFlutterEngine(@NonNull FlutterEngine flutterEngine) {
        ...
        for (FlutterEngineAttachmentListener listener : flutterEngineAttachmentListeners) {
            listener.onFlutterEngineAttachedToXFlutterView(flutterEngine);
        }
        ...
        // with a XFlutterView that is only partially attached to a FlutterEngine.
    ...
    /**
     * Disconnects this {@code XFlutterView} from a previously attached {@link FlutterEngine}.
     *
     * <p>This {@code XFlutterView} will clear its UI and stop forwarding all events to the
    ...
    public void detachFromFlutterEngine() {
        ...
        for (FlutterEngineAttachmentListener listener : flutterEngineAttachmentListeners) {
            listener.onFlutterEngineDetachedFromXFlutterView();
        }
    ...
    /** Returns true if this {@code XFlutterView} is currently attached to a {@link FlutterEngine}. */
    @VisibleForTesting
    ...
    /**
     * Returns the {@link FlutterEngine} to which this {@code XFlutterView} is currently attached, or
     * null if this {@code XFlutterView} is not currently attached to a {@link FlutterEngine}.
     */
    @VisibleForTesting
    @Nullable
     ...
     * XFlutterView} attached to/detaches from a {@link FlutterEngine}.
     */
    @VisibleForTesting
        ...
        if (!isAttachedToFlutterEngine()) {
            Log.w(
                    ...
                    "Tried to send viewport metrics from Android to Flutter but this "
                            + "XFlutterView was not attached to a FlutterEngine.");
            return;
        }
    ...
    /**
     * Render modes for a {@link XFlutterView}.
     *
    ...
    public enum RenderMode {
         ...
         * mode has the best performance, but a {@code XFlutterView} in this mode cannot be positioned
         ...
         * This mode is not as performant as {@link RenderMode#surface}, but a {@code XFlutterView} in
         ...
         * performant as {@link RenderMode#surface}, but a {@code XFlutterView} in this mode can handle
    ...
    /**
     * Transparency mode for a {@code XFlutterView}.
     *
     ...
     * FlutterSurfaceView}, which is displayed when a {@code XFlutterView} uses {@link
     * RenderMode#surface}.
     *
     * <p>{@code TransparencyMode} does not impact {@link FlutterTextureView}, which is displayed when
     * a {@code XFlutterView} uses {@link RenderMode#texture}, because a {@link FlutterTextureView}
     * automatically comes with transparency.
     */
    @Deprecated
    public enum TransparencyMode {
        /**
         * Renders a {@code XFlutterView} without any transparency. This affects {@code XFlutterView}s in
        ...
        opaque,
        /**
         * Renders a {@code XFlutterView} with transparency. This affects {@code XFlutterView}s in {@link
    ...
    public interface FlutterEngineAttachmentListener {
        /** The given {@code engine} has been attached to the associated {@code XFlutterView}. */
        void onFlutterEngineAttachedToXFlutterView(@NonNull FlutterEngine engine);

        /**
         * A previously attached {@link FlutterEngine} has been detached from the associated {@code
         * XFlutterView}.
         */
        void onFlutterEngineDetachedFromXFlutterView();
    }
}
